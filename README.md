...
## 📖 О проекте
BurgerFlow — это Fullstack-приложение НЕ для заказа бургеров. Мы сфокусировались на чистоте кода, скорости работы и интерфейсе, от которого просыпается аппетит.
...
* Styling: CSS (стильно, модно, адаптивно)
* Backend: js
...
* мы не осуществляем досавку и ничего не продаём